...
public class GUI extends JFrame {
	...
	public GUI(String[][]cluster1 , String[][]cluster2 , String[][]cluster3 , String[][]cluster4 , String[][]knn1 , String[][]knn2 , 
		...
		JButton btnKnn = new JButton("K-means Clustering Tables");
		...
		btnKnn.setFont(new Font("Tahoma", Font.BOLD, 46));
		btnKnn.setBounds(29, 41, 729, 172);
		contentPane.add(btnKnn);
		
		JButton button = new JButton("KNN Classification Tables");
		button.setFont(new Font("Tahoma", Font.BOLD, 46));
